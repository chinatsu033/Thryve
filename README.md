...
https://chinatsu033.github.io/psych-state-journal/
...
- **身心**：睡眠、轻量饮食、抑郁发作（时间、感受、严重度、症状清单）
...
- React Router（`basename: /psych-state-journal`，适配 GitHub Pages）
...
> **Base path**：生产构建使用 `base: '/psych-state-journal/'`（见 `vite.config.ts`）。  
...
4. 访问：`https://chinatsu033.github.io/psych-state-journal/`
